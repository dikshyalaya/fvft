                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Add New Job Category To Your Job Preference',
                        style: FreeVisaFreeTicketTheme.caption1Style,
                      ),
                      SizedBox(height: 60.h),
                      CustomDropDownWithSearch(
                        dropDownItems:
                            locator<JobFilterProvider>().jobCategoryNameList,
                        searchFieldTitle: 'Select a job category',
                        textFieldTitle: 'Search a job category',
                        ...
                        onChanged: Provider.of<JobPreferenceUIProvider>(context,
                                listen: false)
                            .setJobCategoryName,
                        validatorFunc: Validator.selectJobCategoryValidator,
                      ),
                  ...
                  return snapShotData.connectionState == ConnectionState.waiting
                      ...
                      : jobPrefsUIProvider.jobCategoryList!.isEmpty
                          ? Padding(
                              ...
                              child: Text(
                                'Do you want to filter job based on your priority in a job post? If yes then press Add (+) button to add your one or multiple job priority based on job category.',
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            ...
            onPressed: () async => await data.saveJobCategory(),
          ),
        ),
      ],
    );
                  ...
                  children: [
                    CustomListTile(
                      ...
                      editTap: () async => await jobPrefsUIProvider
                          .deleteParticularJobFromPrefs(e),
                      subTitle: '',
                    ),
