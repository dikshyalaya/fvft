    ...
    return
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              _buildTitleAndValue(title: 'Material Status', value: 'Single'),
              _buildTitleAndValue(
        ...
        Padding(
          ...
          child: Column(
            children: [
              _buildTitleAndValue(title: 'Passport No.', value: '987654321'),
              _buildTitleAndValue(title: 'Passport Exp.', value: '2030 May 20'),
            ],
          ),
        ),
        SizedBox(height: 10.h),
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              _buildTitleAndValue(title: 'Email ID', value: 'test@test.com'),
              _buildTitleAndValue(
                  title: 'Address',
                  value:
